    ...
    void ApplyBlendMode(C3D_TexEnv* env, BlendMode mode) {
        switch(mode) {
            case BlendMode::Mask: // multiplies the buffer contents by the mask texture
                ...
                C3D_TexEnvOpRgb(env, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0); // and the rest is the same as blend
                C3D_TexEnvOpAlpha(env, GPU_TEVOP_A_SRC_ALPHA, GPU_TEVOP_A_SRC_ALPHA, (GPU_TEVOP_A)0);
            ...
            case BlendMode::Replace:
                ...
                C3D_TexEnvOpRgb(env, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0);
                C3D_TexEnvOpAlpha(env, GPU_TEVOP_A_SRC_ALPHA, GPU_TEVOP_A_SRC_ALPHA, (GPU_TEVOP_A)0);
            ...
            case BlendMode::Blend:
                C3D_AlphaBlend(GPU_BLEND_ADD, GPU_BLEND_ADD, GPU_ONE, GPU_ONE_MINUS_SRC_ALPHA, GPU_ONE, GPU_ONE_MINUS_SRC_ALPHA); // premult
                C3D_TexEnvOpRgb(env, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0, (GPU_TEVOP_RGB)0);
                C3D_TexEnvOpAlpha(env, GPU_TEVOP_A_SRC_ALPHA, GPU_TEVOP_A_SRC_ALPHA, (GPU_TEVOP_A)0); // for color, the second op was 0... but that's the same value so whatever
